...
class TestNoteCreation(TestCase):
    ...
    def _check_notes_count(self, expected_count):
    ...
    def test_empty_slug(self):
        ...
        self.assertEqual(
            Note.objects.get(slug=expected_slug).slug,
            expected_slug
        )
